        ...
        return <Navbar bg="white" expand="lg" className="navBar fixed-top align-items center shadow rounded">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav animation={"false"} className="mr-auto">
                    <Nav.Link as={Link} to="/admin" onClick={()=> new Admin().listarUsuarios()} >Mis amigos</Nav.Link>
                </Nav>
            </Navbar.Collapse>
         </Navbar>;
   }
        ...
        return <Navbar bg="white" expand="lg" className="navBar fixed-top align-items center shadow rounded">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav animation={"false"} className="mr-auto">
                    ...
                    <Nav.Link as={Link} to="/amigos" onClick={()=> new Friends().listarPeticionesPendientes()} >Mis amigos</Nav.Link>
